...
export default function App() {
  ...
  // Load saved notes or fetch first-time JSON
  useEffect(() => {
  ...
  // Save notes + update categories list
  useEffect(() => {
  ...
  function resolveDuplicateTitle(existingNotes, candidate) {
    const sameCat = existingNotes.filter(n => n.category === candidate.category);
    const titles = sameCat.map(n => n.title);
